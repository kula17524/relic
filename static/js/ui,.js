...
addpincontents += '<form method="POST" enctype="multipart/form-data" onsubmit="return requiredRadio()">';
...
addpincontents += '<i class="fa-solid fa-location-dot"></i><input class="sidebox" type="text" name="location" placeholder="場所名を入力してね！" />';
addpincontents += '</div>';
addpincontents += '<p>コンテンツ <span class="required">*</span></p>';
addpincontents += '<div class="cp_iptxt">';
addpincontents += '<i class="fa-solid fa-tag"></i><input class="sidebox" type="text" name="content" placeholder="コンテンツの名前を入力してね！" />';
addpincontents += '</div>';
addpincontents += '<p>位置情報付きの写真 <span class="required">*</span></p>';
addpincontents += '<div id="calculator">';
addpincontents += '<div class="element" data-element="file_upload01" data-conditionalelement="undefined" data-conditionalelementvalue="undefined">';
addpincontents += '<label style="color:#333333">file_upload01</label>';
addpincontents += '<input id="fileinput" class="calc-prop" data-identifier="file_upload01" data-isrequired="false" type="file" name="file" accept=".jpg">';
addpincontents += '</div>';
...
addpincontents += '<input id="pinType1" type="radio" value="oshikey.png" name="pinType">';
addpincontents += '<label for="pinType1"><img src="../static/ico/oshikey.png"></label>';

addpincontents += '<input id="pinType2" type="radio" value="goods.png" name="pinType">';
addpincontents += '<label for="pinType2"><img src="../static/ico/goods.png"></label>';

addpincontents += '<input id="pinType3" type="radio" value="place.png" name="pinType">';
addpincontents += '<label for="pinType3"><img src="../static/ico/place.png"></label>';
addpincontents += '</div>';

addpincontents += '<p>タグ <span class="required">*</span></p>';
addpincontents += '<div class="sideimg">';
addpincontents += '<input id="tagType1" type="radio" value="anime.png" name="tagType">';
addpincontents += '<label for="tagType1"><img src="../static/ico/anime.png" alt="アニメ"></label>';

addpincontents += '<input id="tagType2" type="radio" value="manga.png" name="tagType">';
addpincontents += '<label for="tagType2"><img src="../static/ico/manga.png" alt="漫画"></label>';

addpincontents += '<input id="tagType3" type="radio" value="novel.png" name="tagType">';
addpincontents += '<label for="tagType3"><img src="../static/ico/novel.png" alt="小説"></label>';

addpincontents += '<input id="tagType4" type="radio" value="film.png" name="tagType">';
addpincontents += '<label for="tagType4"><img src="../static/ico/film.png" alt="映画"></label>';

addpincontents += '<input id="tagType5" type="radio" value="drama.png" name="tagType">';
addpincontents += '<label for="tagType5"><img src="../static/ico/drama.png" alt="ドラマ"></label>';

addpincontents += '<input id="tagType6" type="radio" value="other.png" name="tagType">';
addpincontents += '<label for="tagType6"><img src="../static/ico/other.png" alt="その他"></label>';
addpincontents += '</div>';

addpincontents += '<div class="remarks">';
addpincontents += '<p>備考</p>';
addpincontents += '<textarea type="text" name="remarks" placeholder="例：3月末に撤去予定です"></textarea>';
